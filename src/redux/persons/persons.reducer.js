...
const initialState = {
  ...
  personAddressAutoCompleteReq: false,
  personAddressAutoCompleteSuccess: null,
  personAddressAutoCompleteErr: null,
};
...
const personsReducer = (state = initialState, { type, payload }) => {
  switch (type) {
    ...
    // ** PERSON ADDRESS AUTOCOMPLETE
    case personsTypes.PERSON_ADDRESS_AUTO_COMPLETE_REQUEST:
      return {
        personAddressAutoCompleteReq: true,
        personAddressAutoCompleteSuccess: null,
        personAddressAutoCompleteErr: null,
      };
    case personsTypes.PERSON_ADDRESS_AUTO_COMPLETE_SUCCESS:
      return {
        personAddressAutoCompleteReq: false,
        personAddressAutoCompleteSuccess: payload,
        personAddressAutoCompleteErr: null,
      };
    case personsTypes.PERSON_ADDRESS_AUTO_COMPLETE_ERROR:
      return {
        personAddressAutoCompleteReq: false,
        personAddressAutoCompleteSuccess: null,
        personAddressAutoCompleteErr: payload,
      };
